...
config = generate_config(drug_encoding = drug_encoding, 
                         ...
                         result_folder = "/content/drive/MyDrive/Colab Notebooks/DeepPurpose_results/NPASS_MPNN_3"
                        )
...
model.save_model('/content/drive/MyDrive/Colab Notebooks/models/NPASS_MPNN_3')
