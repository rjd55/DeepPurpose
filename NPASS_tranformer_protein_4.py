...
train, val, test = data_process(X_drugs, X_targets, y, 
                                ...
                                split_method='random',frac=[0.85,0.1,0.05], random_seed = 5)
...
config = generate_config(drug_encoding = drug_encoding, 
                         ...
                         result_folder = "/content/drive/MyDrive/Colab Notebooks/DeepPurpose_results/NPASS_tranformer_protein_4"
                        )
...
model.save_model('/content/drive/MyDrive/Colab Notebooks/models/NPASS_tranformer_protein_4')
